    ...
    public partial class MainWindow : Window
    {
        ...
        private void ButtonOpen_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (result == true)
            {
                ...
                ImageOriginal.Source = convertBitmapToBitmapImage(BitmapOriginal);
                ImageGray.Source = convertBitmapToBitmapImage(convertToGrayscale(BitmapOriginal));
                ImageEdited.Source = null;
                Optimal.Text = "null";
            }
        }
        ...
        private Bitmap applyOtsuThreshold(Bitmap BitmapOriginal)
        {
            ...
            Console.WriteLine("Threshold Value" + optimal);
            Optimal.Text = optimal.ToString();
